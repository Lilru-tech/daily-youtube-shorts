...
DATOS_ES = ChannelProfile(
    ...
    gemini_fallback_models=["gemini-2.0-flash", "gemini-2.5-flash-lite", "gemini-1.5-flash"],
...
WHATIFVIBE = ChannelProfile(
    ...
    gemini_fallback_models=["gemini-1.5-flash", "gemini-2.0-flash", "gemini-2.5-flash-lite"],
